...
const styles = StyleSheet.create({
    ...
    filterScroll: { marginVertical: 10, maxHeight: 36 },
    filterContainer: { paddingHorizontal: 20, alignItems: 'center' },
    filterChip: { paddingHorizontal: 14, height: 28, borderRadius: 14, marginRight: 8, justifyContent: 'center', alignItems: 'center' },
